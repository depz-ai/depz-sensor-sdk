...
DEPZ monorepo; this repo mirrors only the C/C++ packages + the golden test
vectors so they can be consumed by CMake FetchContent, Conan and vcpkg (which
fetch source at build time and therefore need a public repository).
